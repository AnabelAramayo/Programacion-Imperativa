...
let inmobiliaria = {
    ...
    listarDepartamentos : function (array){
        for (let i =0; i<array.length; i++){
            ...
            let aceptaMascotas=arrayDepartamentos[i].aceptaMascotas;
            let cantidadPersonas=arrayDepartamentos[i].cantidadPersonas;
            let precioAlquiler=arrayDepartamentos[i].precioAlquiler;
            console.log("El id es " + id + ", los propietarios son: " + propietarios + ", la cantidad de habitaciones son: " + cantidadHabitacion + "¿Esta disponible?: " + disponible + ", ¿Acepta Mascotas?: " + aceptaMascotas + ", La cantidad de personas son: " + cantidadPersonas + "y el precio de alquiel es: " + precioAlquiler)
        }
    }
}
// B
